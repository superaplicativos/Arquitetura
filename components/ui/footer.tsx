  ...
  return (
    <footer>
        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">
              Curso de Produção de Conteúdo para Arquitetos, Designers de Interiores e Engenheiros com IA
            </div>
            <div className="text-sm text-gray-600">
              &copy; 2026 GuiMiranda.Tech - Todos os direitos reservados.
            </div>
          </div>
          ...
          {/* 4th block - Contato Direto */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-medium">Contato Direto</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a
            ...
            <ul className="flex gap-2">
              <li>
                <a
                  ...
                  href="https://www.instagram.com/guimiranda.tech/"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <li>
                <a
                  className="flex h-8 w-8 items-center justify-center rounded-full bg-indigo-500 text-white transition hover:bg-indigo-600"
                  href="https://www.linkedin.com/in/desenvolvimentodeaplicativos"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                >
      ...
      <div className="relative -mt-16 h-60 w-full" aria-hidden="true">
        <div className="pointer-events-none absolute left-1/2 -z-10 -translate-x-1/2 text-center text-[348px] font-bold leading-none before:bg-linear-to-b before:from-gray-200 before:to-gray-100/30 before:to-80% before:bg-clip-text before:text-transparent before:content-['IA'] after:absolute after:inset-0 after:bg-gray-300/70 after:bg-clip-text after:text-transparent after:mix-blend-darken after:content-['IA'] after:[text-shadow:0_1px_0_white]"></div>
        {/* Glow */}
        <div
          className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-2/3"
          aria-hidden="true"
        >
          <div className="h-56 w-56 rounded-full border-[20px] border-indigo-700 blur-[80px]"></div>
        </div>
      </div>
    </footer>
  );
